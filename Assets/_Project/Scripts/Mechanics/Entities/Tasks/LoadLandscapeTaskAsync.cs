...
namespace _Project.Mechanics.Entities.Tasks
{
    public class LoadLandscapeTaskAsync : AsyncTask
    {
        ...
        [Inject] private GameFieldFactory _gameFieldFactory;
        ...
        protected override async UniTask DoAsync()
        {
            ...
            _landscapeProvider.CurrentLandscape = _gameFieldFactory.Instantiate(template, _landscapesConfig.Landscapes[DefaultLandscapeIndex]);
        }
    }
}